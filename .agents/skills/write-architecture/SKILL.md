...
1. Run `xxx context architecture`, `xxx inspect`, and inspect entry points, modules, manifests, build/runtime configuration, integrations, persistence, and data/state boundaries as needed.
...
4. Run `xxx validate ARCHITECTURE.md --json`, repair all actionable failures, and repeat until valid.
