...
const domains = z.enum(["architecture", "backend", "frontend", "security", "reliability", "product"]);
export type ContextDomain = z.infer<typeof domains>;
const documentByDomain: Record<ContextDomain, string[]> = { architecture: ["ARCHITECTURE.md", "docs/DESIGN.md"], backend: ["docs/BACKEND.md"], frontend: ["docs/FRONTEND.md"], security: ["docs/SECURITY.md"], reliability: ["docs/RELIABILITY.md"], product: ["docs/PRODUCT_SENSE.md"] };
